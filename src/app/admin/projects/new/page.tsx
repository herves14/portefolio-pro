          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                placeholder="Une description brève qui apparaîtra sur la carte du projet"
              />
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                placeholder="Quel problème ce projet résout-il ? Quel impact a-t-il eu ?"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                type="text"
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                placeholder="Ex: React, Node.js, PostgreSQL, Tailwind CSS"
              />
              {errors.technologies && (
                <p className="mt-1 text-sm text-red-600">
